...
@Composable
fun DialogSelectComponent(
    modifier: Modifier = Modifier,
    onDismiss: () -> Unit,
    onConfirm: (ComponentType) -> Unit,
    options: EnumEntries<ComponentType>,
    defaultOption: ComponentType? = null
) {

    var selected: ComponentType? by remember { mutableStateOf(value = defaultOption) }
